...
#code checks size of crawled text to determine whether to recrawl or not
...
if __name__ == '__main__':
    ...
    sql_projects = "Select ProjectName,ProjectWebpage,FirstDataSource,DataSources_idDataSources,idProjects from Projects where Exclude=0 and DateOfLastCrawl is not Null and Translated=0 and idProjects>7006"
