...
def main(collection_name, projects_files_path=None):
    ...
    if projects_files_path is None:
        mongo_ids = p_collector.get_mongodb_projects_ids(collection_name)
    ...
    for project_id in tqdm(project_ids, "Predicting projects location"):
        project_data = p_collector.get_text_mongodb(project_id=project_id, collection_name=collection_name)
